  ...
  public Animator createAnimator(
    ...
    final TransitionDrawable transitionDrawable =
        new TransitionDrawable(
            getPathMotion(),
            copyViewImage(sceneRoot, startView, startView.getParent() instanceof View ? startView.getParent() : startView),
            startBounds,
            startShapeAppearanceModel,
            getElevationOrDefault(startElevation, startView),
            copyViewImage(sceneRoot, endView, endView.getParent() instanceof View ? endView.getParent() : endView),
            endBounds,
